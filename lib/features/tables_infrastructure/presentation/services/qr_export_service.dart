        ...
        pw.MultiPage(
          ...
          build: (pw.Context context) {
              ...
              return pw.Container(
                ...
                child: pw.Column(
                  ...
                  children: [
                    ...
                    if (table.displayName != null && table.displayName!.isNotEmpty)
                      pw.Text(
                        table.displayName!,
            ...
            return [
              pw.Header(
                level: 0,
                child: pw.Text('QR Codes - $branchName', style: pw.TextStyle(fontSize: 24, fontWeight: pw.FontWeight.bold)),
              ),
              if (isRoll)
                pw.Column(
                  children: gridItems.map((item) => pw.Padding(padding: const pw.EdgeInsets.only(bottom: 24), child: item)).toList(),
                )
              else
                pw.GridView(
                  crossAxisCount: 3,
