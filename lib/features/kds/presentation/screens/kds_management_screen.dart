...
class KdsManagementScreen extends ConsumerWidget {
  ...
  void _showKdsForm(BuildContext context, WidgetRef ref, {KitchenStationDto? existing}) {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: asyncStations.when(
        ...
        error: (err, st) => Center(
          child: Text('Error loading stations: $err',
  ...
  Widget _buildEmptyState() {
    return Center(
      child: Column(
        ...
        children: [
          Icon(Icons.kitchen_outlined, size: 64, color: AppTheme.secondary.withOpacity(0.5)),
          const SizedBox(height: 16),
          Text('No Kitchen Stations',
              style: GoogleFonts.inter(fontSize: 20, fontWeight: FontWeight.bold)),
          const SizedBox(height: 8),
          Text('Create stations (e.g. Grill, Bar) to route orders.',
  ...
  Widget _buildList(List<KitchenStationDto> stations, BuildContext context, WidgetRef ref) {
            ...
            child: Row(
              children: [
                ...
                Switch(
                  ...
                  onChanged: (val) async {
                    await ref.read(kdsRepositoryProvider).toggleStation(station.id, val);
                    ref.invalidate(kitchenStationsProvider);
                  },
                ),
                IconButton(
                  ...
                  onPressed: () async {
                    await ref.read(kdsRepositoryProvider).deleteStation(station.id);
                    ref.invalidate(kitchenStationsProvider);
                  },
                ),
              ],
    ...
    return Container(
      ...
      child: Form(
        ...
        child: Column(
          ...
          children: [
            Text(widget.existing == null ? 'Create Station' : 'Edit Station',
                style: GoogleFonts.inter(fontSize: 20, fontWeight: FontWeight.bold)),
            ...
            SwitchListTile(
              title: Text('Default Station', style: GoogleFonts.inter(fontWeight: FontWeight.bold)),
              subtitle: Text('Unrouted items will be sent here.', style: GoogleFonts.inter(fontSize: 12, color: AppTheme.secondary)),
              value: _isDefault,
            ...
            FilledButton(
              ...
              child: _isLoading 
                  ...
                  : Text('Save Station', style: GoogleFonts.inter(fontWeight: FontWeight.bold, fontSize: 16)),
            ),
          ],
        ),
      ),
