...
class AnalyticsNotifier extends StateNotifier<AnalyticsState> {
  ...
  Future<void> fetchDailySummary({
    ...
    final result = await _repository.getDailySummary(
      date: date,
      branchId: branchId,
    );

    if (result is Success<DailySummaryProjectionDto>) {
      final newCache = Map<String, DailySummaryProjectionDto>.from(
...
final dailySummaryProvider =
    Provider.family<DailySummaryProjectionDto?, Map<String, dynamic>>((
      ref,
      params,
    ) {
