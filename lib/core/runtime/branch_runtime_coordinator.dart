...
final runtimeSwitchStateProvider = StateProvider<RuntimeSwitchState>((ref) => RuntimeSwitchState.idle);
...
class BranchRuntimeCoordinator {
  ...
  Future<void> switchBranch(String newBranchId) async {
    ...
    _ref.read(runtimeSwitchStateProvider.notifier).state = RuntimeSwitchState.switching;
    ...
    try {
      ...
      _ref.read(runtimeSwitchStateProvider.notifier).state = RuntimeSwitchState.failed;
    } finally {
      _ref.read(runtimeSwitchStateProvider.notifier).state = RuntimeSwitchState.idle;
    }
  }
}

final branchRuntimeCoordinatorProvider = Provider<BranchRuntimeCoordinator>((ref) {
